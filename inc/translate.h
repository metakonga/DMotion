...
public:
	...
	bool                                  importModel(const QString& file, const int, const Handle(AIS_InteractiveContext)&);
	//bool                                  exportModel(const QString& file, const int, const Handle(AIS_InteractiveContext)&);
