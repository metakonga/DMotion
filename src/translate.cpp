...
bool Translate::importModel(const QString& file, const int format, const Handle(AIS_InteractiveContext)& ic)
{
	myInfo = QString();
...
// 	{
// 		myInfo = QObject::tr("File %1 not found").arg(fileName);
// 		return false;
// 	}

	QApplication::setOverrideCursor(Qt::WaitCursor);
	Handle(TopTools_HSequenceOfShape) shapes = importModel(format, file);
...
// bool Translate::exportModel(const QString& file, const int format, const Handle(AIS_InteractiveContext)& ic)
// {
// 	myInfo = QString();
...
// 		return myDlg;
// 
// 	QString formatFilter = QObject::tr(QString("IGES Files(*.igs *.iges)").toLatin1().constData());
// 	QString allFilter = QObject::tr("All Files (*.*)");
// 
// 	QString filter;
...
// 	if (import)
// 	{
// 		myDlg->setWindowTitle(QObject::tr("Import file"));
// 		((QFileDialog*)myDlg)->setFileMode(QFileDialog::ExistingFile);
// 	}
// 	else
// 	{
// 		myDlg->setWindowTitle(QObject::tr("Export file"));
...
// 		{
// 		case FormatSTEP:
// 			myDlg->addMode(STEPControl_ManifoldSolidBrep, QObject::tr("Manifold Solid Brep"));
// 			myDlg->addMode(STEPControl_FacetedBrep, QObject::tr("Faceted Brep"));
// 			myDlg->addMode(STEPControl_ShellBasedSurfaceModel, QObject::tr("Shell Based Surface Model"));
// 			myDlg->addMode(STEPControl_GeometricCurveSet, QObject::tr("Geometric Curve Set"));
// 			break;
// 		}
// 	}
// 
...
// 		Handle(AIS_Shape) s = new AIS_Shape(aShape);
// 		gp_Trsf t;
// 		gp_Ax1 Ax1(gp_Pnt(0, 0, 0), gp_Vec(0, 0, 1));
// 		t.SetRotation(Ax1, M_PI * 0.5);
// 		DMotion::getAISContext()->SetLocation(s, t);
		aSequence->Append(aShape);
	}
	return aSequence;
}
...
// 	{
// 		myInfo = QObject::tr("At least one shape doesn't contain facetes");
// 		return false;
// 	}
// 
...
// 		myInfo = QObject::tr("Incorrect Data.");
// 		break;
// 	case IFSelect_RetFail:
// 		myInfo = QObject::tr("INF_WRITING_ERROR");
// 		break;
// 	case IFSelect_RetVoid:
// 		myInfo = QObject::tr("Nothing to transfer.");
// 		break;
// 	}
...
// 		if (shape.IsNull())
// 		{
// 			myInfo = QObject::tr("Some shapes are invalid.");
// 			return false;
// 		}
